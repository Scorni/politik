...
final class Version20230310174849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE mep (id INTEGER NOT NULL, fullname VARCHAR(255) NOT NULL, country VARCHAR(255) NOT NULL, national_political_group VARCHAR(255) NOT NULL, contacts CLOB NOT NULL --(DC2Type:array)
        , PRIMARY KEY(id))');
